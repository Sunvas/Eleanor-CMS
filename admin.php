...
CMS::$A=new Authorization('a11n_adminpanel',0,require ROOT.'external.php');

#Access to admin panel should have users with root or team rights
...
if(CMS::$A->current)
{
	#File for admin panel could be easily renamed, so lets update its name in the system cache
