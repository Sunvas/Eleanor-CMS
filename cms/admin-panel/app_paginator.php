<ul class="pagination mb-0" v-if="pages>1">
	...
	<li class="page-item" v-else-if="page>3"><span class="page-link" role="button" @click="InputPage">&hellip;</span></li>
	...
	<li class="page-item" v-else-if="pages>page+2"><span class="page-link" role="button" @click="InputPage">&hellip;</span></li>
