...
<head>
	...
	<script src="static/admin-panel/index.js" nonce="<?=$nonce?>" data-cron="<?=CMS::$T->cron ? 1 : ''?>" defer></script>
...
<nav class="sidebar sidebar-dark sidebar-fixed border-end hide" id="sidebar">
	<div class="sidebar-header border-bottom">
		...
		<button class="btn-close d-lg-none" type="button" data-coreui-theme="dark" title="<?=$l10n['close']?>"></button>
	</div>
	...
	<footer class="sidebar-footer border-top d-none d-md-flex">
		<button class="sidebar-toggler" type="button" title="<?=$l10n['pin']?>"></button>
	</footer>
</nav>
<div class="wrapper d-flex flex-column min-vh-100">
	<header class="header header-sticky p-0 mb-3 shadow-sm">
		<div class="container-fluid border-bottom px-4">
			<button class="header-toggler" type="button" style="margin-inline-start: -1rem" title="<?=$l10n['sidebar']?>">
			...
			<ul class="header-nav">
				<li class="nav-item dropdown">
					...
					<ul class="dropdown-menu dropdown-menu-end" style="--cui-dropdown-min-width: 8rem;">
						<li>
							<a class="dropdown-item" href="<?=Classes\Uri4AdminPanel::$base?>?u=users&amp;id=<?=CMS::$A->current?>">
