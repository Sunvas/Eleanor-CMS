...
class Ukrainian
{
	...
	{
		return str_replace(
			array('а','б','в','г','д','е','з','и','і','й','к','л','м','н','о','п','р','с','т','у','ф','х','ц','ы','ё', 'ж', 'ч', 'ш', 'щ',  'э', 'ю', 'я', 'ї', 'ъ', 'ь', 'А','Б','В','Г','Д','Е','З','И','І','Й','К','Л','М','Н','О','П','Р','С','Т','У','Ф','Х','Ц','Ы','Ё', 'Ж', 'Ч', 'Ш', 'Щ',  'Э', 'Ю', 'Я', 'Ї', 'Ъ', 'Ь',),
			array('a','b','v','g','d','e','z','i','i','y','k','l','m','n','o','p','r','s','t','u','f','h','c','y','yo','zh','ch','sh','sch','ye','yu','ya','yi','\'','\'','A','B','V','G','D','E','Z','I','I','Y','K','L','M','N','O','P','R','S','T','U','F','H','C','Y','Yo','Zh','Ch','Sh','Sch','Ye','Yu','Ya','Yi','\'','\''),
			$s
		);
	}
