...
(5, 'file', 'addons/menus/block.php', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, '', 0, '', 1),
...
(33, 3, 'edit', 'noavatar', 1, 4, 0, '', ''),
(34, 3, 'edit', 'guest_avatar', 1, 5, 0, '', ''),
(35, 3, 'user', 'time_online', 1, 7, 0, '', ''),
(36, 3, 'select', 'antibrute', 1, 8, 0, '', ''),
(37, 3, 'edit', 'antibrute_cnt', 1, 9, 0, '', 'if(\$co[''multilang''])\\r\\n{\\r\\n	foreach(\$co[''value''] as &\$v)\\r\\n		\$v=abs((int)\$v);\\r\\n	return\$co[''value''];\\r\\n}\\r\\nreturn abs((int)\$co[''value'']);'),
(38, 3, 'edit', 'antibrute_time', 1, 10, 0, 'if(\$co[''multilang''])\\r\\n	foreach(\$co[''value''] as &\$v)\\r\\n		\$v=round(\$v/60);\\r\\nelse\\r\\n	\$co[''value'']=round(\$co[''value'']/60);\\r\\nreturn\$co;', 'if(\$co[''multilang''])\\r\\n{\\r\\n	foreach(\$co[''value''] as &\$v)\\r\\n		\$v=abs((int)\$v*60);\\r\\n	return\$co[''value''];\\r\\n}\\r\\nreturn abs((int)\$co[''value'']*60);'),

(39, 4, 'text', 'blocked_names', 1, 1, 0, '', ''),
(40, 4, 'text', 'blocked_emails', 1, 2, 0, '', ''),
(41, 4, 'select', 'reg_type', 1, 3, 0, '', ''),
(42, 4, 'input', 'reg_act_time', 1, 4, 0, 'if(\$co[''multilang''])\\r\\n{\\r\\n	foreach(\$co[''value''] as &\$v)\\r\\n		\$v=abs(round((int)\$v/3600));\\r\\n}\\r\\nelse\\r\\n	\$co[''value'']=abs(round((int)\$co[''value'']/3600));\\r\\nreturn\$co;', 'if(\$co[''multilang''])\\r\\n{\\r\\n	foreach(\$co[''value''] as &\$v)\\r\\n		\$v=abs((int)\$v)*3600;\\r\\n	return\$co[''value''];\\r\\n}\\r\\nreturn abs((int)\$co[''value'']*3600);'),
(43, 4, 'select', 'reg_unactivated', 1, 5, 0, '', ''),
(44, 4, 'check', 'reg_off', 1, 6, 0, '', ''),
(45, 4, 'edit', 'max_name_length', 1, 7, 0, '', 'if(\$co[''multilang''])\\r\\n	foreach(\$co[''value''] as &\$v)\\r\\n	{\\r\\n		\$v=abs((int)\$v);\\r\\n		if(\$v<5)\\r\\n			\$v=5;\\r\\n	}\\r\\nelse\\r\\n{\\r\\n	\$co[''value'']=abs((int)\$co[''value'']);\\r\\n	if(\$co[''value'']<5)\\r\\n		\$co[''value'']=5;\\r\\n}\\r\\nreturn\$co[''value''];'),
(46, 4, 'edit', 'min_pass_length', 1, 8, 0, '', 'if(\$co[''multilang''])\\r\\n{\\r\\n	foreach(\$co[''value''] as &\$v)\\r\\n		\$v=abs((int)\$v);\\r\\n	return\$co[''value''];\\r\\n}\\r\\nreturn abs((int)\$co[''value'']);'),
(47, 4, 'edit', 'avatar_bytes', 1, 9, 0, 'if(\$co[''multilang''])\\r\\n{\\r\\n	foreach(\$co[''value''] as &\$v)\\r\\n		\$v=abs(round((int)\$v/1024));\\r\\n}\\r\\nelse\\r\\n	\$co[''value'']=abs(round((int)\$co[''value'']/1024));\\r\\nreturn\$co;', 'if(\$co[''multilang''])\\r\\n{\\r\\n	foreach(\$co[''value''] as &\$v)\\r\\n		\$v=abs((int)\$v)*1024;\\r\\n	return\$co[''value''];\\r\\n}\\r\\nreturn abs((int)\$co[''value'']*1024);'),
(48, 4, 'edit', 'avatar_size', 1, 10, 0, '', 'if(\$co[''multilang''])\\r\\n{\\r\\n	foreach(\$co[''value''] as &\$v)\\r\\n		if(preg_match(''#^\\\\d+ \\\\d+\$#'',\$v)==0)\\r\\n			throw new EE(''incorrect_format'',EE::INFO,array(''lang''=>true));\\r\\n}\\r\\nelseif(preg_match(''#^\\\\d+ \\\\d+\$#'',\$co[''value''])==0)\\r\\n	throw new EE(''incorrect_format'',EE::INFO,array(''lang''=>true));\\r\\nreturn\$co[''value''];'),
(49, 4, 'select', 'account_pass_rec_t', 1, 11, 0, '', ''),

(50, 5, 'edit', 'captcha_length', 1, 1, 0, '', 'if(\$co[''multilang''])\\r\\n{\\r\\n	foreach(\$co[''value''] as &\$v)\\r\\n		\$v=abs((int)\$v);\\r\\n	return\$co[''value''];\\r\\n}\\r\\nreturn abs((int)\$co[''value'']);'),
(51, 5, 'edit', 'captcha_symbols', 1, 2, 0, '', ''),
(52, 5, 'edit', 'captcha_width', 1, 3, 0, '', 'if(\$co[''multilang''])\\r\\n{\\r\\n	foreach(\$co[''value''] as &\$v)\\r\\n		\$v=abs((int)\$v);\\r\\n	return\$co[''value''];\\r\\n}\\r\\nreturn abs((int)\$co[''value'']);'),
(53, 5, 'edit', 'captcha_height', 1, 4, 0, '', 'if(\$co[''multilang''])\\r\\n{\\r\\n	foreach(\$co[''value''] as &\$v)\\r\\n		\$v=abs((int)\$v);\\r\\n	return\$co[''value''];\\r\\n}\\r\\nreturn abs((int)\$co[''value'']);'),
(54, 5, 'edit', 'captcha_fluctuation', 1, 5, 0, '', 'if(\$co[''multilang''])\\r\\n{\\r\\n	foreach(\$co[''value''] as &\$v)\\r\\n		\$v=abs((int)\$v);\\r\\n	return\$co[''value''];\\r\\n}\\r\\nreturn abs((int)\$co[''value'']);'),

(55, 6, 'edit', 'log_errors', 1, 1, 0, '', ''),
(56, 6, 'edit', 'log_exceptions', 1, 2, 0, '', ''),
(57, 6, 'edit', 'log_site_errors', 1, 3, 0, '', ''),
(58, 6, 'edit', 'log_db_errors', 1, 4, 0, '', ''),
(59, 6, 'edit', 'log_maxsize', 1, 5, 0, 'if(\$co[''multilang''])\\r\\n	foreach(\$co[''value''] as &\$v)\\r\\n		\$v=abs(round((int)\$v/1024));\\r\\nelse\\r\\n	\$co[''value'']=abs(round((int)\$co[''value'']/1024));\\r\\nreturn\$co;', 'if(\$co[''multilang''])\\r\\n{\\r\\n	foreach(\$co[''value''] as &\$v)\\r\\n		\$v=abs((int)\$v)*1024;\\r\\n	return\$co[''value''];\\r\\n}\\r\\nreturn abs((int)\$co[''value'']*1024);'),

(60, 7, 'select', 'mail_method', 1, 1, 0, '', ''),
(61, 7, 'edit', 'mail_from', 1, 2, 0, '', 'if(!Strings::CheckEmail(\$co[''value'']))\\r\\n	throw new EE(''incorrect_email'',EE::INFO,array(''lang''=>true));\\r\\nreturn\$co[''value''];'),
(62, 7, 'select', 'mail_priority', 1, 3, 0, '', ''),
(63, 7, 'edit', 'mail_reply', 1, 4, 0, '', 'if(!Strings::CheckEmail(\$co[''value''],false))\\r\\n	throw new EE(''incorrect_email'',EE::INFO,array(''lang''=>true));\\r\\nreturn\$co[''value''];'),
(64, 7, 'edit', 'mail_notice', 1, 5, 0, '', 'if(!Strings::CheckEmail(\$co[''value''],false))\\r\\n	throw new EE(''incorrect_email'',EE::INFO,array(''lang''=>true));\\r\\nreturn\$co[''value''];'),
(65, 7, 'edit', 'mail_smtp_user', 1, 6, 0, '', ''),
(66, 7, 'edit', 'mail_smtp_pass', 1, 7, 0, '', ''),
(67, 7, 'edit', 'mail_smtp_host', 1, 8, 0, '', ''),
(68, 7, 'edit', 'mail_smtp_port', 1, 9, 0, '', ''),

(69, 8, 'select', 'editor_type', 1, 1, 0, '', ''),
(70, 8, 'text', 'bad_words', 1, 2, 0, '', ''),
(71, 8, 'edit', 'bad_words_replace', 1, 3, 1, '', ''),
(72, 8, 'select', 'antidirectlink', 1, 4, 0, '', ''),
(73, 8, 'check', 'autoparse_urls', 1, 5, 0, '', ''),

(74, 9, 'uploadimage', 'rss_image', 1, 1, 0, '', ''),

(75, 10, 'select', 'comments_sort', 1, 1, 0, '', ''),
(76, 10, 'edit', 'comments_pp', 1, 2, 0, '', 'if(\$co[''multilang''])\\r\\n	foreach(\$co[''value''] as &\$v)\\r\\n	{\\r\\n		\$v=abs((int)\$v);\\r\\n		if(\$v==0)\\r\\n			\$v=10;\\r\\n	}\\r\\nelse\\r\\n{\\r\\n	\$co[''value'']=abs((int)\$co[''value'']);\\r\\n	if(\$co[''value'']==0)\\r\\n		\$co[''value'']=10;\\r\\n}\\r\\nreturn\$co[''value''];'),
(77, 10, 'edit', 'comments_timelimit', 1, 3, 0, '', 'if(\$co[''multilang''])\\r\\n{\\r\\n	foreach(\$co[''value''] as &\$v)\\r\\n		\$v=abs((int)\$v);\\r\\n	return\$co[''value''];\\r\\n}\\r\\nreturn abs((int)\$co[''value'']);'),
(78, 10, 'items', 'comments_display_for', 1, 5, 0, '', ''),
(79, 10, 'items', 'comments_post_for', 1, 6, 0, '', ''),

(80, 11, 'check', 'thumbs', 1, 1, 0, '', ''),
(81, 11, 'edit', 'thumb_types', 1, 2, 0, '', ''),
(82, 11, 'edit', 'thumb_width', 1, 3, 0, '', 'if(\$co[''multilang''])\\r\\n{\\r\\n	foreach(\$co[''value''] as &\$v)\\r\\n		\$v=abs((int)\$v);\\r\\n}\\r\\nelse\\r\\n	\$co[''value'']=abs((int)\$co[''value'']);\\r\\nreturn\$co[''value''];'),
(83, 11, 'edit', 'thumb_height', 1, 4, 0, '', 'if(\$co[''multilang''])\\r\\n{\\r\\n	foreach(\$co[''value''] as &\$v)\\r\\n		\$v=abs((int)\$v);\\r\\n}\\r\\nelse\\r\\n	\$co[''value'']=abs((int)\$co[''value'']);\\r\\nreturn\$co[''value''];'),
(84, 11, 'select', 'thumb_reducing', 1, 5, 0, '', ''),
(85, 11, 'select', 'thumb_first', 1, 6, 0, '', ''),
(86, 11, 'check', 'watermark', 1, 7, 0, '', ''),
(87, 11, 'edit', 'watermark_types', 1, 8, 0, '', ''),
(88, 11, 'edit', 'watermark_alpha', 1, 9, 0, '', 'if(\$co[''multilang''])\\r\\n{\\r\\n	foreach(\$co[''value''] as &\$v)\\r\\n	{\\r\\n		\$v=abs((int)\$v);\\r\\n		if(\$v>100)\\r\\n			\$v=100;\\r\\n	}\\r\\n}\\r\\nelse\\r\\n{\\r\\n	\$co[''value'']=abs((int)\$co[''value'']);\\r\\n	if(\$co[''value'']>100)\\r\\n		\$co[''value'']=100;\\r\\n}\\r\\nreturn\$co[''value''];'),
(89, 11, 'edit', 'watermark_top', 1, 10, 0, '', 'if(\$co[''multilang''])\\r\\n{\\r\\n	foreach(\$co[''value''] as &\$v)\\r\\n	{\\r\\n		\$v=abs((int)\$v);\\r\\n		if(\$v>100)\\r\\n			\$v=100;\\r\\n	}\\r\\n}\\r\\nelse\\r\\n{\\r\\n	\$co[''value'']=abs((int)\$co[''value'']);\\r\\n	if(\$co[''value'']>100)\\r\\n		\$co[''value'']=100;\\r\\n}\\r\\nreturn\$co[''value''];'),
(90, 11, 'edit', 'watermark_left', 1, 11, 0, '', 'if(\$co[''multilang''])\\r\\n{\\r\\n	foreach(\$co[''value''] as &\$v)\\r\\n	{\\r\\n		\$v=abs((int)\$v);\\r\\n		if(\$v>100)\\r\\n			\$v=100;\\r\\n	}\\r\\n}\\r\\nelse\\r\\n{\\r\\n	\$co[''value'']=abs((int)\$co[''value'']);\\r\\n	if(\$co[''value'']>100)\\r\\n		\$co[''value'']=100;\\r\\n}\\r\\nreturn\$co[''value''];'),
(91, 11, 'edit', 'watermark_image', 1, 12, 0, '', ''),
(92, 11, 'edit', 'watermark_string', 1, 13, 1, '', ''),
(93, 11, 'edit', 'watermark_csa', 1, 14, 0, '', 'if(\$co[''multilang''])\\r\\n{\\r\\n	foreach(\$co[''value''] as &\$v)\\r\\n		if(preg_match(''#^\\\\d+,\\\\d+,\\\\d+,\\\\d+,\\\\d+\$#'',\$v)==0)\\r\\n			throw new EE(''incorrect_format'',EE::INFO,array(''lang''=>true));\\r\\n}\\r\\nelse\\r\\n{\\r\\n	if(preg_match(''#^\\\\d+,\\\\d+,\\\\d+,\\\\d+,\\\\d+\$#'',\$co[''value''])==0)\\r\\n		throw new EE(''incorrect_format'',EE::INFO,array(''lang''=>true));\\r\\n}\\r\\nreturn\$co[''value''];'),
(94, 11, 'check', 'download_antileech', 1, 15, 0, '', ''),
(95, 11, 'check', 'download_no_session', 1, 16, 0, '', ''),

(96, 12, 'edit', 'multisite_secret', 0, 1, 0, '', ''),
(97, 12, 'edit', 'multisite_ttl', 0, 2, 0, '', 'if(\$co[''multilang''])\\r\\n{\\r\\n	foreach(\$co[''value''] as &\$v)\\r\\n		\$v=abs((int)\$v);\\r\\n	return\$co[''value''];\\r\\n}\\r\\nreturn abs((int)\$co[''value'']);'),

(98, 13, 'edit', 'drafts_days', 0, 1, 0, '', 'if(\$co[''multilang''])\r\n{\r\n	foreach(\$co[''value''] as &\$v)\r\n		\$v=(int)\$v;\r\n	return\$co[''value''];\r\n}\r\nreturn(int)\$co[''value''];'),
(99, 13, 'edit', 'drafts_autosave', 0, 2, 0, '', 'if(\$co[''multilang''])\r\n{\r\n	foreach(\$co[''value''] as &\$v)\r\n		\$v=(int)\$v;\r\n	return\$co[''value''];\r\n}\r\nreturn(int)\$co[''value''];'),

(100, 14, 'user', 'm_static_general', 1, 1, 0, '', ''),

(101, 15, 'edit', 'publ_per_page', 0, 1, 0, '', 'if(\$co[''multilang''])\\r\\n{\\r\\n	foreach(\$co[''value''] as &\$v)\\r\\n		\$v=abs((int)\$v);\\r\\n	return\$co[''value''];\\r\\n}\\r\\nreturn abs((int)\$co[''value'']);'),
(102, 15, 'edit', 'publ_rss_per_page', 0, 3, 0, '', 'if(\$co[''multilang''])\\r\\n{\\r\\n	foreach(\$co[''value''] as &\$v)\\r\\n		\$v=abs((int)\$v);\\r\\n	return\$co[''value''];\\r\\n}\\r\\nreturn abs((int)\$co[''value'']);'),
(103, 15, 'check', 'publ_add', 0, 4, 0, '', ''),
(104, 15, 'check', 'publ_catsubcat', 0, 5, 0, '', ''),
(105, 15, 'check', 'publ_ping', 0, 6, 0, '', ''),
(106, 15, 'check', 'publ_rating', 0, 7, 0, '', ''),
(107, 15, 'check', 'publ_mark_details', 0, 8, 0, '', ''),
(108, 15, 'check', 'publ_mark_users', 0, 9, 0, '', ''),
(109, 15, 'edit', 'publ_remark', 0, 10, 0, '', 'if(\$co[''multilang''])\\r\\n	foreach(\$co[''value''] as &\$v)\\r\\n		\$v=max((int)\$v,1);\\r\\nelse\\r\\n	\$co[''value'']=max((int)\$co[''value''],1);\\r\\nreturn\$co[''value''];'),
(110, 15, 'edit', 'publ_lowmark', 0, 11, 0, '', 'if(\$co[''multilang''])\\r\\n	foreach(\$co[''value''] as &\$v)\\r\\n		\$v=min((int)\$v,0);\\r\\nelse\\r\\n	\$co[''value'']=min((int)\$co[''value''],0);\\r\\nreturn\$co[''value''];'),
(111, 15, 'edit', 'publ_highmark', 0, 12, 0, '', 'if(\$co[''multilang''])\\r\\n	foreach(\$co[''value''] as &\$v)\\r\\n		\$v=max((int)\$v,0);\\r\\nelse\\r\\n	\$co[''value'']=max((int)\$co[''value''],0);\\r\\nreturn\$co[''value''];')
QUERY;
...
$ser=array(
	...
	'sg'=>'include Eleanor::$root.\'\'modules/statis/optionsg.php\'\'',
	'pd'=>'array(
		\'\'options\'\'=>array(
			\'\'ignore\'\'=>\'\'Игнорировать\'\',
...
(33, 'russian', 'Аватар пользователя без аватара', 'Относительно корня сайта', 'images/avatars/avatar.png', 0, 'images/avatars/avatar.png', '', 'Пути'),
(34, 'russian', 'Аватар гостя', 'Относительно корня сайта', 'images/avatars/guest.png', 0, 'images/avatars/guest.png', '', ''),
(35, 'russian', 'Длительность сессий', 'Количество секунд во время которых пользователь считается онлайн после проявления активности.', 'a:4:{s:10:"LoginAdmin";i:900;s:9:"LoginBase";i:900;s:10:"LoginModer";i:300;s:7:"LoginNo";i:10;}', 1, 'a:4:{s:10:"LoginAdmin";i:900;s:9:"LoginBase";i:900;s:10:"LoginModer";i:300;s:7:"LoginNo";i:10;}', '{$ser['time_online']}', 'Параметры аутентификации и авторизации'),
(36, 'russian', 'Тип защиты', '', '1', 0, '1', '{$ser['ab']}', 'Защита от подбора пароля'),
(37, 'russian', 'Максимальное число неудачных попыток аутентификации', '', '5', 0, '5', '', ''),
(38, 'russian', 'Максимальный промежуток времени в минутах, во время которого допускаются неудачные попытки аутентификации', 'Пример: если максимальное число неудачных попыток аутентификации равно 5, а заданное значение равно 15, то пользователь будет заблокирован в случае если за последние 15 минут было 5 неудачных попыток входа.', '600', 0, '600', '', ''),

(39, 'russian', 'Заблокированные ники', 'Через запятую. Допустимые спецсимволы: * - любая последовательность символов, ? - любой один символ.', '', 0, '', '', 'Блокировки'),
(40, 'russian', 'Заблокированные e-mail', 'Через запятую. Допустимые спецсимволы: * - любая последовательность символов, ? - любой один символ.', '', 0, '', '', ''),
(41, 'russian', 'Активация новосозданного пользователя', '', '1', 0, '1', '{$ser['aa']}', 'Регистрация'),
(42, 'russian', 'Срок активации', 'Количество часов отведенных для активации учетной записи', '86400', 0, '86400', 'array(''type''=>''number'',''addon''=>array(''min''=>1));', ''),
(43, 'russian', 'Как поступать с неактивированными учетными записями', '', '1', 0, '1', '{$ser['ua']}', ''),
(44, 'russian', 'Отключить регистрацию?', '', '0', 0, '0', '', ''),
(45, 'russian', 'Максимальная длина ника', '', '15', 0, '15', '', ''),
(46, 'russian', 'Минимальная длина пароля', '', '7', 0, '7', '', ''),
(47, 'russian', 'Максимальный размер загружаемого аватара в KB', '', '307200', 0, '307200', '', 'Профиль'),
(48, 'russian', 'Максимальный размер аватара', 'Вводить нужно в формате: ширина[пробел]высота.', '100 100', 0, '100 100', '', ''),
(49, 'russian', 'Восстановление пароля', '', '1', 0, '1', '{$ser['rp']}', ''),

(50, 'russian', 'Количество символов в captcha', '', '5', 0, '5', '', 'Настройки captcha'),
(51, 'russian', 'Алфавит captcha', 'Символы, используемые в captcha (желательно исключить похожие символы, как 0— цифра и o — буква)', '23456789abcdeghkmnpqsuvxyz', 0, '23456789abcdeghkmnpqsuvxyz', '', ''),
(52, 'russian', 'Ширина captcha', '', '120', 0, '120', '', ''),
(53, 'russian', 'Высота captcha', '', '60', 0, '60', '', ''),
(54, 'russian', 'Разброс символов по вертикали', 'Максимальное отклонение символов по вертикали от центра.', '5', 0, '5', '', ''),

(55, 'russian', 'Лог-файл ошибок кода', '', 'addons/logs/errors.log', 0, 'addons/logs/errors.log', '', 'Логирование ошибок'),
(56, 'russian', 'Лог-файл неперехваченных исключений', '', 'addons/logs/exceptions.log', 0, 'addons/logs/exceptions.log', '', ''),
(57, 'russian', 'Лог-файл ошибок сайта', '', 'addons/logs/site_errors.log', 0, 'addons/logs/site_errors.log', '', ''),
(58, 'russian', 'Лог-файл базы данных (включая запросы)', '', 'addons/logs/db_errors.log', 0, 'addons/logs/db_errors.log', '', ''),
(59, 'russian', 'Предельный размер файла', 'Указывается в килобайтах. После достижения этого размера, файл автоматически упаковывается Gzip или BZip2 архив. Укажите 0 для отключения автоматического сжатия.', '2097152', 0, '2097152', '', ''),

(60, 'russian', 'Способ отправки e-mail', '', 'mail', 0, 'mail', 'array(''options''=>array(''php''=>''PHP mail'',''smtp''=>''SMTP'',))', 'Общие настройки'),
(61, 'russian', 'E-mail отправителя', '', '{$email}', 0, '{$email}', '', ''),
(62, 'russian', 'Важность', '', '3', 0, '3', '{$ser['pr']}', ''),
(63, 'russian', 'E-mail для ответа', 'В случае, если ответы от пользователей необходимо принимать на другой e-mail, заполните это поле.', '', 0, '', '', ''),
(64, 'russian', 'E-mail для подтверждения о прочтении', '', '', 0, '', '', ''),
(65, 'russian', 'Логин', 'Пользователь', '', 0, '', '', 'Настройки SMTP'),
(66, 'russian', 'Пароль', '', '', 0, '', '', ''),
(67, 'russian', 'Хост', 'Сервер', '', 0, '', '', ''),
(68, 'russian', 'Порт', '', '25', 0, '25', '', ''),

(69, 'russian', 'Редактор по умолчанию', '', 'bb', 0, 'bb', 'array(''eval''=>''return Eleanor::getInstance()->Editor->editors;'')', ''),
(70, 'russian', 'Запрещенные слова', 'Маты и ругательства. Через запятую.', 'slaed, slaed cms, Edmann, DiFor, zigmat, peter911', 0, 'slaed, slaed cms, Edmann, DiFor, zigmat, peter911', '', ''),
(71, 'russian', 'Автозамена запрещенных слов', '', '*Цензура*', 0, '*Цензура*', '', ''),
(72, 'russian', 'Включить защиту от прямых ссылок?', '', 'go', 0, 'go', 'array(''options''=>array(''нет'',''go''=>''Редирект через go.php'',''nofollow''=>''rel="nofollow"'',))', ''),
(73, 'russian', 'Включить автоопределение ссылок в тексте?', 'При включении этой опции, все ссылки опубликованные как текст - будут обработаны как ссылки.', '1', 0, '1', '', ''),

(74, 'russian', 'Логотип RSS', '', 'images/rss.png', 0, 'images/rss.png', 'array(''path''=>''uploads/'',''types''=>array(0=>''jpeg'',1=>''jpg'',2=>''png'',3=>''bmp'',4=>''gif'',),''max_size''=>''307200'',''filename_eval''=>'''',)', ''),

(75, 'russian', 'Порядок сортировки комментариев', '', '1', 0, '1', '{$ser['or']}', ''),
(76, 'russian', 'Комментариев на страницу', '', '10', 0, '10', '', ''),
(77, 'russian', 'Ограничение изменения по времени', 'Введите количество секунд, по истечению которых пользователи не смогут удалять / править свои комментарии. Отсчет времени осуществляется с момента публикации комментария.', '86400', 0, '86400', '', ''),
(78, 'russian', 'Отображать комментарии для', '', 'a:6:{i:0;s:1:"4";i:1;s:1:"1";i:2;s:1:"3";i:3;s:1:"6";i:4;s:1:"5";i:5;s:1:"2";}', 1, 'a:6:{i:0;s:1:"4";i:1;s:1:"1";i:2;s:1:"3";i:3;s:1:"6";i:4;s:1:"5";i:5;s:1:"2";}', '{$ser['groups']}', 'Права'),
(79, 'russian', 'Публикация комментариев доступна для', '', 'a:2:{i:0;s:1:"1";i:1;s:1:"2";}', 1, 'a:2:{i:0;s:1:"1";i:1;s:1:"2";}', '{$ser['groups']}', ''),

(80, 'russian', 'Включить создание превью для загружаемых изображений?', '', '1', 0, '1', '', 'Превью изображений'),
(81, 'russian', 'Типы файлов для которых создавать превью', '', 'png,jpg,bmp', 0, 'png,jpg,bmp', '', ''),
(82, 'russian', 'Ширина превью', 'Введите 0 для сохранения исходной ширины изображения', '200', 0, '200', '', ''),
(83, 'russian', 'Высота превью', 'Введите 0 для сохранения исходной высоты изображения', '0', 0, '0', '', ''),
(84, 'russian', 'Способ уменьшения изображения', '', 'small', 0, 'small', '{$ser['cu']}', ''),
(85, 'russian', 'Создание превью начать с', '', 'b', 0, 'b', '{$ser['cf']}', ''),
(86, 'russian', 'Включить водяной знак?', 'Наложить водяной знак на загружаемые картинки?', '1', 0, '1', '', 'Настройки водяного знака'),
(87, 'russian', 'Типы файлов для водяного знака', 'На эти типы файлов будет ставиться водяной знак. Указывайте, разделяя запятыми.', 'jpg,jpeg,png,bmp', 0, 'jpg,jpeg,png,bmp', '', ''),
(88, 'russian', 'Прозрачность водяного знака (в процентах от 0 до 100)', '100 - не видно водяного знака', '50', 0, '50', '', ''),
(89, 'russian', 'Положение по вертикали (в процентах от 0 до 100)', '', '50', 0, '50', '', ''),
(90, 'russian', 'Положение по горизонтали (в процентах от 0 до 100)', '', '50', 0, '50', '', ''),
(91, 'russian', 'Файл водяного знака', 'Введите путь к рисунку на сервере, который будет использован в качества водяного знака (например: images/watermrak.jpg). Обратите внимание, что водяной знак не будет применён на изображение если по размерам оно меньше, чем водяной знак. Имеет приоритет над текстом водяного знака.', 'images/watermark.png', 0, 'images/watermark.png', '', ''),
(92, 'russian', 'Текст водяного знака', 'Этот текст будет наложен на изображение в качестве водяного знака, если изображение водяного знака недоступно.', '© {$sitename}', 0, '© {$sitename}', '', ''),
(93, 'russian', 'Цвет, размер и угол текста водяного знака', 'Задается в формате red,green,blue,size,angle', '1,1,1,15,0', 0, '1,1,1,15,0', '', ''),
(94, 'russian', 'Запретить скачивание с других сайтов?', 'При включении этой опции, при попытке скачать файл будет проверяться адрес страницы, с которой пришел пользователь. Если это будет чужая страница, пользователь не сможет скачать файл.', '1', 0, '1', '', 'Скачивание файлов'),
(95, 'russian', 'Запретить скачивание без сессии?', 'При включении этой опции, пользователь, IP адрес которого не присутствует в списке сессий, не сможет скачать файл.', '1', 0, '1', '', ''),

(96, 'russian', 'Секрет сайта', 'Случайная секретная строка при помощи которой будут подписываться данные для кросс-доменной коммутации.', '{$secret}', 0, '{$secret}', '', ''),
(97, 'russian', 'Срок жизни данных кросс-доменной коммутации', 'В секундах.', '100', 0, '100', '', ''),

(98, 'russian', 'Сколько дней хранить черновики?', '', '10', 0, '10', '', ''),
(99, 'russian', 'Интервал автосохранения в секундах', '', '20', 0, '20', '', ''),

(100, 'russian', 'Страницы, выводимые на главной', 'Оставьте пустым для вывода содержания', '', 0, '', '{$ser['sg']}', ''),

(101, 'russian', 'Публикаций на страницу', '', '10', 0, '10', '', 'Основные'),
(102, 'russian', 'Публикаций на страницу в RSS', '', '30', 0, '30', '', ''),
(103, 'russian', 'Добавление новостей пользователями', '', '1', 0, '1', '', ''),
(104, 'russian', 'Выводить содержимое подкатегорий при просмотре категории', '', '1', 0, '1', '', ''),
(105, 'russian', 'Включить ping', 'Уведомление поисковых систем об обновлении на сайте', '1', 0, '1', '', ''),
(106, 'russian', 'Включить рейтинг', '', '1', 0, '1', '', 'Настройки рейтинга'),
(107, 'russian', 'Оценка только при подробном просмотре?', 'Разрешить оценивать публикации только при их подробном просмотре?', '0', 0, '0', '', ''),
(108, 'russian', 'Рейтинг только для пользователей', 'При включении этой опции, выставлять новости оценку смогут только авторизованные пользователи и только 1 раз.', '0', 0, '0', '', ''),
(109, 'russian', 'Период между оцениваниями в днях', 'Если выставлять оценку могут не только пользователи, но и гости, эта опция определяет время, по истечению которого гость сможет вновь выставить оценку.', '3', 0, '3', '', ''),
(110, 'russian', 'Минимальная негативная оценка', 'Значение не может быть выше нуля. Для отключения негативных оценок, введите 0.', '-3', 0, '-3', '', ''),
(111, 'russian', 'Максимальная позитивная оценка', 'Значение не может быть ниже нуля. Для отключения позитивных оценок, введите 0.', '3', 0, '3', '', '')
QUERY;
#[E] Russian
...
(33, 'ukrainian', 'Аватар користувача без аватара', 'Відносно кореню сайту', 'images/avatars/avatar.png', 0, 'images/avatars/avatar.png', '', 'Шляхи'),
(34, 'ukrainian', 'Аватар гостя', 'Відносно кореню сайту', 'images/avatars/guest.png', 0, 'images/avatars/guest.png', '', ''),
(35, 'ukrainian', 'Тривалість сесій', 'Кількість секунд під час яких користувач вважається онлайн після прояву активності.', 'a:4:{s:10:"LoginAdmin";i:900;s:9:"LoginBase";i:900;s:10:"LoginModer";i:300;s:7:"LoginNo";i:10;}', 1, 'a:4:{s:10:"LoginAdmin";i:900;s:9:"LoginBase";i:900;s:10:"LoginModer";i:300;s:7:"LoginNo";i:10;}', '{$ser['time_online']}', 'Параметри аутентифікації та авторизації'),
(36, 'ukrainian', 'Тип захисту', '', '1', 0, '', '{$ser['ab']}', 'Захист від підбору паролів'),
(37, 'ukrainian', 'Максимальна кількість невдалих спроб аутентифікації', '', '5', 0, '5', '', ''),
(38, 'ukrainian', 'Максимальний проміжок часу в хвилинах, під час якого допускаються невдалі спроби аутентифікації', 'Приклад: якщо максимальне число невдалих спроб аутентифікації дорівнює 5, а задане значення дорівнює 15, то користувач буде заблокований у разі якщо за останні 15 хвилин було 5 невдалих спроб входу.', '600', 0, '600', '', ''),

(39, 'ukrainian', 'Заблоковані прізвиська', 'Через кому. Допустимі спецсимволи: * - будь-яка послідовність символів,? - будь-який один символ.', '', 0, '', '', 'Блокування'),
(40, 'ukrainian', 'Заблоковані e-mail', 'Через кому. Допустимі спецсимволи: * - будь-яка послідовність символів,? - будь-який один символ.', '', 0, '', '', ''),
(41, 'ukrainian', 'Активація новоствореного користувача', '', '1', 0, '1', '{$ser['aa']}', 'Реєстрація'),
(42, 'ukrainian', 'Термін активації', 'Кількість годин відведених для активації облікового запису.', '86400', 0, '86400', 'array(''type''=>''number'',''addon''=>array(''min''=>1));', ''),
(43, 'ukrainian', 'Як поступати з неактивованими обліковими записами', '', '1', 0, '1', '{$ser['ua']}', ''),
(44, 'ukrainian', 'Вимкнути реєстрацію?', '', '0', 0, '0', '', ''),
(45, 'ukrainian', 'Максимальна довжина імені', '', '15', 0, '15', '', ''),
(46, 'ukrainian', 'Мінімальна довжина пароля', '', '7', 0, '7', '', ''),
(47, 'ukrainian', 'Максимальний розмір завантажуваного аватара в KB', '', '307200', 0, '307200', '', 'Профіль'),
(48, 'ukrainian', 'Максимальний розмір аватара', 'Вводити потрібно в форматі: ширина[пробіл]висота.', '100 100', 0, '100 100', '', ''),
(49, 'ukrainian', 'Відновлення пароля', '', '1', 0, '1', '{$ser['rp']}', ''),

(50, 'ukrainian', 'Кількість символів в captcha', '', '5', 0, '5', '', 'Налаштування captcha'),
(51, 'ukrainian', 'Алфавіт captcha', 'Символи що використовуються в captcha (бажано вилучити подібні символи, такі як 0 - цифра і o - буква)', '23456789abcdeghkmnpqsuvxyz', 0, '23456789abcdeghkmnpqsuvxyz', '', ''),
(52, 'ukrainian', 'Ширина captcha', '', '120', 0, '120', '', ''),
(53, 'ukrainian', 'Висота captcha', '', '60', 0, '60', '', ''),
(54, 'ukrainian', 'Розкид символів по вертикалі', 'Максимальне відхилення символів по вертикалі від центру.', '5', 0, '5', '', ''),

(55, 'ukrainian', 'Лог-файл помилок коду', '', 'addons/logs/errors.log', 0, '', '', 'Логування помилок'),
(56, 'ukrainian', 'Лог-файл не перехоплених винятків', '', 'addons/logs/exceptions.log', 0, '', '', ''),
(57, 'ukrainian', 'Лог-файл помилок сайту', '', 'addons/logs/site_errors.log', 0, '', '', ''),
(58, 'ukrainian', 'Лог-файл бази даних (включаючи запити)', '', 'addons/logs/db_errors.log', 0, '', '', ''),
(59, 'ukrainian', 'Граничний розмір файлу', 'Зазначається у кілобайтах. Після досягнення цього розміру, файл автоматично запаковується Gzip або BZip2 архів. Вкажіть 0 для відключення автоматичного стиснення.', '2097152', 0, '2097152', '', ''),

(60, 'ukrainian', 'Спосіб відправки e-mail', '', 'mail', 0, 'mail', 'array(''options''=>array(''php''=>''PHP mail'',''smtp''=>''SMTP'',))', 'Загальні налаштування'),
(61, 'ukrainian', 'E-mail відправника', 'С какого ящика будут приходить письма?', '{$email}', 0, '{$email}', '', ''),
(62, 'ukrainian', 'Важливість', '', '3', 0, '3', '{$ser['pr']}', ''),
(63, 'ukrainian', 'E-mail для відповіді', 'У разі, якщо відповіді від користувачів необхідно приймати на інший e-mail, заповніть це поле.', '', 0, '', '', ''),
(64, 'ukrainian', 'E-mail для підтвердження про прочитання', '', '', 0, '', '', ''),
(65, 'ukrainian', 'Логін', 'Користувач', '', 0, '', '', 'Установки SMTP'),
(66, 'ukrainian', 'Пароль', '', '', 0, '', '', ''),
(67, 'ukrainian', 'Хост', 'Сервер', '', 0, '', '', ''),
(68, 'ukrainian', 'Порт', '', '25', 0, '25', '', ''),

(69, 'ukrainian', 'Редактор по замовчуванню', '', 'bb', 0, 'bb', 'array(''eval''=>''return Eleanor::getInstance()->Editor->editors;'')', ''),
(70, 'ukrainian', 'Заборонені слова', 'Мати й лайки. Через кому.', 'slaed, slaed cms, Edmann, DiFor, zigmat, peter911', 0, 'slaed, slaed cms, Edmann, DiFor, zigmat, peter911', '', ''),
(71, 'ukrainian', 'Автозаміна заборонених слів', '', '*Цензура*', 0, '*Цензура*', '', ''),
(72, 'ukrainian', 'Активувати захист від прямих посилань?', '', 'go', 0, 'go', 'array(''options''=>array(''ні'',''go''=>''Редірект через go.php'',''nofollow''=>''rel="nofollow"'',))', ''),
(73, 'ukrainian', 'Включити автовизначення посилань у тексті?', 'При включенні цієї опції, всі посилання опубліковані як текст - будуть оброблені як посилання.', '1', 0, '1', '', ''),

(74, 'ukrainian', 'Логотип RSS', '', 'images/rss.png', 0, 'images/rss.png', 'array(''path''=>''uploads/'',''types''=>array(0=>''jpeg'',1=>''jpg'',2=>''png'',3=>''bmp'',4=>''gif'',),''max_size''=>''307200'',''filename_eval''=>'''',)', ''),

(75, 'ukrainian', 'Порядок сортування коментарів', '', '1', 0, '1', '{$ser['or']}', ''),
(76, 'ukrainian', 'Коментарів на сторінку', '', '10', 0, '10', '', ''),
(77, 'ukrainian', 'Обмеження зміни за часом', 'Введіть кількість секунд, після завершення яких користувачі не зможуть видаляти / редагувати свої коментарі. Відлік часу здійснюється з моменту публікації коментаря.', '86400', 0, '86400', '', ''),
(78, 'ukrainian', 'Відображати коментарі для', '', 'a:6:{i:0;s:1:"4";i:1;s:1:"1";i:2;s:1:"3";i:3;s:1:"6";i:4;s:1:"5";i:5;s:1:"2";}', 1, 'a:6:{i:0;s:1:"4";i:1;s:1:"1";i:2;s:1:"3";i:3;s:1:"6";i:4;s:1:"5";i:5;s:1:"2";}', '{$ser['groups']}', 'Права'),
(79, 'ukrainian', 'Публікація коментарів доступна для', '', 'a:2:{i:0;s:1:"1";i:1;s:1:"2";}', 1, 'a:2:{i:0;s:1:"1";i:1;s:1:"2";}', '{$ser['groups']}', ''),

(80, 'ukrainian', 'Включити створення прев''ю для завантажуваних зображень?', '', '1', 0, '1', '', 'Превью зображень'),
(81, 'ukrainian', 'Типи файлів для яких створювати превью', 'Укажите типы файлов для которых будут создаваться превью (через запятую).', 'png,jpg,bmp', 0, 'png,jpg,bmp', '', ''),
(82, 'ukrainian', 'Ширина превью', 'Введіть 0 для збереження вихідної ширини зображення', '200', 0, '200', '', ''),
(83, 'ukrainian', 'Висота прев''ю', 'Введіть 0 для збереження вихідної висоти зображення', '0', 0, '0', '', ''),
(84, 'ukrainian', 'Спосіб зменшення зображення', '', 'small', 0, 'small', '{$ser['cu']}', ''),
(85, 'ukrainian', 'Створення превью почати з', '', 'b', 0, 'b', '{$ser['cf']}', ''),
(86, 'ukrainian', 'Включити водяний знак?', 'Накласти водяний знак на завантажувані картинки?', '1', 0, '1', '', 'Настройки ватермарка'),
(87, 'ukrainian', 'Типи файлів для водяного знака', 'На ці типи файлів буде ставитися водяний знак. Вказуйте, розділяючи комами.', 'jpg,jpeg,png,bmp', 0, 'jpg,jpeg,png,bmp', '', ''),
(88, 'ukrainian', 'Прозорість водяного знаку (у відсотках від 0 до 100)', '100 - не видно водяного знаку', '50', 0, '50', '', ''),
(89, 'ukrainian', 'Положення по вертикалі (у відсотках від 0 до 100)', '', '50', 0, '50', '', ''),
(90, 'ukrainian', 'Положення по горизонталі (у відсотках від 0 до 100)', '', '50', 0, '50', '', ''),
...
(92, 'ukrainian', 'Текст водяного знака', 'Цей текст буде накладено на зображення в якості водяного знака, якщо зображення водяного знака недоступне.', '© {$sitename}', 0, '© {$sitename}', '', ''),
(93, 'ukrainian', 'Колір, розмір і кут тексту водяного знака', 'Задається в форматі red, green, blue, size, angle', '1,1,1,15,0', 0, '1,1,1,15,0', '', ''),
(94, 'ukrainian', 'Заборонити скачування з інших сайтів?', 'При включенні цієї опції, при спробі завантажити файл буде перевірятися адресу сторінки, з якою прийшов користувач. Якщо це буде чужа сторінка, користувач не зможе завантажити файл.', '1', 0, '1', '', 'Завантаження файлів'),
(95, 'ukrainian', 'Заборонити скачування без сесії?', 'При включенні цієї опції, користувач, IP-адреса якого не присутній у списку сесій, не зможе завантажити файл.', '1', 0, '1', '', ''),

(96, 'ukrainian', 'Секрет сайту', 'Випадковий секретний рядок за допомогою якого будуть підписуватися дані для міждоменної комутації.', '{$secret}', 0, '{$secret}', '', ''),
(97, 'ukrainian', 'Термін життя даних крос-доменної комутації', 'У секундах.', '100', 0, '100', '', ''),

(98, 'ukrainian', 'Скільки днів зберігати чернетки?', '', '10', 0, '10', '', ''),
(99, 'ukrainian', 'Інтервал автозбереження в секундах', '', '20', 0, '20', '', ''),

(100, 'ukrainian', 'Сторінки, що виводиться на головній', 'Залиште пустим для виведення змісту', '', 0, '', '{$ser['sg']}', ''),

(101, 'ukrainian', 'Публікацій на сторінку', '', '10', 0, '10', '', 'Загальні'),
(102, 'ukrainian', 'Публікацій на сторінку в RSS', '', '30', 0, '30', '', ''),
(103, 'ukrainian', 'Додавання новин користувачами', '', '1', 0, '1', '', ''),
(104, 'ukrainian', 'Виводити вміст підкатегорій при перегляді категорії', '', '1', 0, '1', '', ''),
(105, 'ukrainian', 'Включити ping', 'Повідомлення пошукових систем про оновлення на сайті', '1', 0, '1', '', ''),
(106, 'ukrainian', 'Включити рейтинг', '', '1', 0, '1', '', 'Настройки рейтингу'),
(107, 'ukrainian', 'Оцінка тільки при детальному перегляді?', 'Дозволити оцінювати публікації тільки при їх детальному перегляді?', '0', 0, '0', '', ''),
(108, 'ukrainian', 'Рейтинг тільки для користувачів', 'При включенні цієї опції, виставляти новини оцінку зможуть лише авторизовані користувачі і лише 1 раз.', '0', 0, '0', '', ''),
(109, 'ukrainian', 'Період між оцінювання у днях', 'Якщо виставляти оцінку можуть не лише користувачі, але й гості, ця опція визначає час, по закінченню якого гість зможе знову виставити оцінку.', '3', 0, '3', '', ''),
(110, 'ukrainian', 'Мінімальна негативна оцінка', 'Значення не може бути більше нуля. Для відключення негативних оцінок, введіть 0.', '-3', 0, '-3', '', ''),
(111, 'ukrainian', 'Максимальна позитивна оцінка', 'Значення не може бути нижче нуля. Для відключення позитивних оцінок, введіть 0', '3', 0, '3', '', '')
QUERY;
#[E] Ukrainian
$ser=array(
	'pd'=>'array(
...
(33, 'english', 'Avatar of user without avatar', 'Relative to the site root', 'images/avatars/avatar.png', 0, 'images/avatars/avatar.png', '', 'Paths'),
(34, 'english', 'Guest avatar', 'Relative to the site root', 'images/avatars/guest.png', 0, 'images/avatars/guest.png', '', ''),
(35, 'english', 'Duration of sessions', 'Number of seconds during which user considered as online after his last activity.', 'a:4:{s:10:"LoginAdmin";i:900;s:9:"LoginBase";i:900;s:10:"LoginModer";i:300;s:7:"LoginNo";i:10;}', 1, 'a:4:{s:10:"LoginAdmin";i:900;s:9:"LoginBase";i:900;s:10:"LoginModer";i:300;s:7:"LoginNo";i:10;}', '{$ser['time_online']}', 'The authentication and authorization'),
(36, 'english', 'Protection type', '', '1', 0, '', '{$ser['ab']}', 'Protection against guessing password'),
(37, 'english', 'The maximum number of unsuccessful authentication attempts', '', '5', 0, '5', '', ''),
(38, 'english', 'The maximum amount of time in minutes, during which allowed failed authentication attempts', 'Example: If the maximum number of failed authentication attempts is 5, and the set value is 15, the user will be blocked if the last 15 minutes were 5 failed login attempts.', '600', 0, '600', '', ''),

(39, 'english', 'Blocked nicknames', 'Separated by commas. Allowable special characters: * - any sequence of characters,? - any one character.', '', 0, '', '', 'Bans'),
(40, 'english', 'Blocked e-mail', 'Separated by commas. Allowable special characters: * - any sequence of characters,? - any one character.', '', 0, '', '', ''),
(41, 'english', 'Activation of newly created user', '', '1', 0, '1', '{$ser['aa']}', 'Register'),
(42, 'english', 'Activation term', 'The number of hours allotted to activate account.', '86400', 0, '86400', 'array(''type''=>''number'',''addon''=>array(''min''=>1));', ''),
(43, 'english', 'How to deal with nonactivated accounts', '', '1', 0, '1', '{$ser['ua']}', ''),
(44, 'english', 'Disable registration?', '', '0', 0, '0', '', ''),
(45, 'english', 'The maximum length of nickname', '', '15', 0, '15', '', ''),
(46, 'english', 'The minimum length of password', '', '7', 0, '7', '', ''),
(47, 'english', 'Maximum size of uploaded avatars in KB', '', '307200', 0, '307200', '', 'Profile'),
(48, 'english', 'Maximum size of avatar', 'Need to enter in the format: width[space]height.', '100 100', 0, '100 100', '', ''),
(49, 'english', 'Password recovery', '', '1', 0, '1', '{$ser['rp']}', ''),

(50, 'english', 'Number of characters in captcha', '', '5', 0, '5', '', 'Captcha options'),
(51, 'english', 'Captcha alphabet', 'Symbols used in the captcha (preferably exclude similar characters like 0 - number and o - letter)', '23456789abcdeghkmnpqsuvxyz', 0, '23456789abcdeghkmnpqsuvxyz', '', ''),
(52, 'english', 'Сaptcha width', '', '120', 0, '120', '', ''),
(53, 'english', 'Captcha height', '', '60', 0, '60', '', ''),
(54, 'english', 'The scatter symbols on the vertical', 'The maximum deviation of the symbols on the vertical line from the center.', '5', 0, '5', '', ''),

(55, 'english', 'Log file code errors', '', 'addons/logs/errors.log', 0, '', '', 'Errors log'),
(56, 'english', 'Log file uncaught exceptions', '', 'addons/logs/exceptions.log', 0, '', '', ''),
(57, 'english', 'Log-file site errors', '', 'addons/logs/site_errors.log', 0, '', '', ''),
(58, 'english', 'Log-file database (including queries)', '', 'addons/logs/db_errors.log', 0, '', '', ''),
(59, 'english', 'Limit file size', 'Specified in kilobytes. After reaching this size, the file is automatically packaged Gzip or BZip2 archive. Specify 0 to disable automatic compression.', '2097152', 0, '2097152', '', ''),

(60, 'english', 'Way to send e-mail', '', 'mail', 0, 'mail', 'array(''options''=>array(''php''=>''PHP mail'',''smtp''=>''SMTP'',))', 'General settiongs'),
(61, 'english', 'Sender e-mail', 'From what email letters will send?', '{$email}', 0, '{$email}', '', 'Общие настройки'),
(62, 'english', 'Importance', '', '3', 0, '3', '{$ser['pr']}', ''),
(63, 'english', 'E-mail for response', 'If the response from the user should be taken to another e-mail, fill out this field.', '', 0, '', '', ''),
(64, 'english', 'E-mail to confirm a read', '', '', 0, '', '', ''),
(65, 'english', 'Login', 'User', '', 0, '', '', 'SMTP settings'),
(66, 'english', 'Password', '', '', 0, '', '', ''),
(67, 'english', 'Host', 'Server', '', 0, '', '', ''),
(68, 'english', 'Port', '', '25', 0, '25', '', ''),

(69, 'english', 'Editor by default', '', 'bb', 0, 'bb', 'array(''eval''=>''return Eleanor::getInstance()->Editor->editors;'')', ''),
(70, 'english', 'Swear words', 'Mats and abuse. Separated by commas.', 'slaed, slaed cms, Edmann, DiFor, zigmat, peter911', 0, 'slaed, slaed cms, Edmann, DiFor, zigmat, peter911', '', ''),
(71, 'english', 'Autocorrect banned words', '', '*Censorship*', 0, '*Censorship*', '', ''),
(72, 'english', 'Enable protection from direct links?', '', 'bb', 0, 'bb', 'array(''options''=>array(''no'',''go''=>''Redirect via go.php'',''nofollow''=>''rel="nofollow"'',))', ''),
(73, 'english', 'Enable autoparse links in the text?', 'If you enable this option, all links published as text - will be treated as links.', '1', 0, '1', '', ''),

(74, 'english', 'RSS logo', '', 'images/rss.png', 0, 'images/rss.png', 'array(''path''=>''uploads/'',''types''=>array(0=>''jpeg'',1=>''jpg'',2=>''png'',3=>''bmp'',4=>''gif'',),''max_size''=>''307200'',''filename_eval''=>'''',)', ''),

(75, 'english', 'Order displaying comments', '', '1', 0, '1', '{$ser['or']}', ''),
(76, 'english', 'Comments per page', '', '10', 0, '10', '', ''),
(77, 'english', 'Limitation of time changes', 'Enter the number of seconds after which users can not delete / edit your comments. The countdown is carried out since the publication of comments.', '86400', 0, '86400', '', ''),
(78, 'english', 'Display comments for', '', 'a:6:{i:0;s:1:"4";i:1;s:1:"1";i:2;s:1:"3";i:3;s:1:"6";i:4;s:1:"5";i:5;s:1:"2";}', 1, 'a:6:{i:0;s:1:"4";i:1;s:1:"1";i:2;s:1:"3";i:3;s:1:"6";i:4;s:1:"5";i:5;s:1:"2";}', '{$ser['groups']}', 'Rights'),
(79, 'english', 'Post comments available for', '', 'a:2:{i:0;s:1:"1";i:1;s:1:"2";}', 1, 'a:2:{i:0;s:1:"1";i:1;s:1:"2";}', '{$ser['groups']}', ''),

(80, 'english', 'Enable the creation of thumbs for uploaded images?', '', '1', 0, '1', '', 'Preview images'),
(81, 'english', 'File types for which to create thumbs', 'Specify the file types for which to create a preview (separated by comma).', 'png,jpg,bmp', 0, 'png,jpg,bmp', '', ''),
(82, 'english', 'Thumb width', 'Enter 0 to keep the original width of the image', '200', 0, '200', '', ''),
(83, 'english', 'Height preview', 'Enter 0 to keep the original height of the image', '0', 0, '0', '', ''),
(84, 'english', 'Method of reducing the image', '', 'small', 0, 'small', '{$ser['cu']}', ''),
(85, 'english', 'Creating a thumb begin with', '', 'b', 0, 'b', '{$ser['cf']}', ''),
(86, 'english', 'Enable a watermark?', 'Apply a watermark to your uploaded images?', '1', 0, '1', '', 'Настройки ватермарка'),
(87, 'english', 'Filetypes for watermark', 'These types of files will be put watermark. Specify, separated by commas.', 'jpg,jpeg,png,bmp', 0, 'jpg,jpeg,png,bmp', '', ''),
(88, 'english', 'Transparency of the watermark (as a percentage from 0 to 100)', '100 - not visible watermark', '50', 0, '50', '', ''),
(89, 'english', 'Vertical position (as a percentage from 0 to 100)', '', '50', 0, '50', '', ''),
(90, 'english', 'Horizontal position (as a percentage from 0 to 100)', '', '50', 0, '50', '', ''),
(91, 'english', 'File of the watermark', 'Enter the path to the picture on the server, which will be used as a watermark (eg: images / watermrak.jpg). Please note that the watermark will not be applied to the image if the size is less than the watermark. Takes precedence over the text watermark.', 'images/watermark.png', 0, 'images/watermark.png', '', ''),
(92, 'english', 'Text watermark', 'This text will be superimposed on the image as a watermark, if the watermark image is not available.', '© {$sitename}', 0, '© {$sitename}', '', ''),
(93, 'english', 'Color, size and angle of text watermark', 'Given in the format of red, green, blue, size, angle', '1,1,1,15,0', 0, '1,1,1,15,0', '', ''),
(94, 'english', 'Prohibit downloads from other sites?', 'When this option when you try to download the file will be checked to indicate the address to which the user came from. If it is someone else''s page, the user can not download the file.', '1', 0, '1', '', 'Downloading files'),
(95, 'english', 'Prohibit downloading without session?', 'When this option is enabled, the user, IP address is not on the list of sessions will not be able to download the file.', '1', 0, '1', '', ''),

(96, 'english', 'Site secret', 'A random secret string with which to sign the data for cross-domain switching.', '{$secret}', 0, '{$secret}', '', ''),
(97, 'english', 'The life of these cross-domain switching', 'In seconds.', '100', 0, '100', '', ''),

(98, 'english', 'Days to keep drafts?', '', '10', 0, '10', '', ''),
(99, 'english', 'Autosave interval in seconds', '', '20', 0, '20', '', ''),

(100, 'english', 'The pages displayed on the main', 'Leave empty to display contents', '', 0, '', '{$ser['sg']}', ''),

(101, 'english', 'Publications per page', '', '10', 0, '10', '', 'General'),
(102, 'english', 'Publications per page in RSS', '', '30', 0, '30', '', ''),
(103, 'english', 'Adding news by users', '', '1', 0, '1', '', ''),
(104, 'english', 'Display the contents of subcategories when viewing category', '', '1', 0, '1', '', ''),
(105, 'english', 'Enable ping', 'Notification search engines about updating on the site', '1', 0, '1', '', ''),
(106, 'english', 'Enable rating', '', '1', 0, '1', '', 'Rating options'),
(107, 'english', 'Score only in the detailed view?', 'Allow to assess publication only when they are detailed viewing?', '0', 0, '0', '', ''),
(108, 'english', 'Rating users only', 'When this option is on, rate news can only authorized users and only 1 time.', '0', 0, '0', '', ''),
(109, 'english', 'Period between marks in days', 'If rate can not only users but also the guests, this option specifies the time after which guests will be able to remark.', '3', 0, '3', '', ''),
(110, 'english', 'Low negative mark', 'Value can not be greater than zero. To turn off the negative marks, enter 0.', '-3', 0, '-3', '', ''),
(111, 'english', 'The maximum positive mark', 'Value can not be below zero. To disable the positive ratings, please enter 0.', '3', 0, '3', '', '')
QUERY;
#[E] English
...
(1, 'russian', 'Главная', '', 'return\$Eleanor->Url->special;', ''),
(2, 'russian', 'Личный кабинет', '', 'return\$Eleanor->Url->special.\$Eleanor->Url->Construct(array(''module''=>''аккаунт''),false);', ''),
(3, 'russian', 'Новости', '', 'return\$Eleanor->Url->special.\$Eleanor->Url->Construct(array(''module''=>''новости''),false);', ''),
(4, 'russian', 'Поиск', '', 'return\$Eleanor->Url->special.\$Eleanor->Url->Construct(array(''module''=>''поиск''),false);', ' rel="search"'),
(5, 'russian', 'Карта сайта', '', 'return\$Eleanor->Url->special.\$Eleanor->Url->Construct(array(''module''=>''карта сайта''),false);', ''),
(6, 'russian', 'Информация', '', 'return\$Eleanor->Url->special.\$Eleanor->Url->Construct(array(''module''=>''страницы''),false);', ''),
(7, 'russian', 'Обратная связь', '', 'return\$Eleanor->Url->special.\$Eleanor->Url->Construct(array(''module''=>''обратная связь''),false);', ' rel="contact"'),
(8, 'russian', 'Eleanor CMS', 'http://eleanor-cms.ru', '', ''),
(9, 'russian', 'Официальный сайт Eleanor CMS', 'http://eleanor-cms.ru', '', ''),
(10, 'russian', 'Форум поддержки', 'http://eleanor-cms.ru/%D1%84%D0%BE%D1%80%D1%83%D0%BC/', '', ''),
(11, 'russian', 'Eleanor Server', 'http://eleanor-cms.ru/%D1%81%D0%B5%D1%80%D0%B2%D0%B5%D1%80/', '', '')
QUERY;
#[E] Russian
...
INSERT INTO `{$prefix}menu_l` (`id`, `language`, `title`, `url`, `eval_url`, `params`) VALUES
(1, 'english', 'Home', '', 'return\$Eleanor->Url->special;', ''),
(2, 'english', 'Personal cabinet', '', 'return\$Eleanor->Url->special.\$Eleanor->Url->Construct(array(''module''=>''account''),false);', ''),
(3, 'english', 'News', '', 'return\$Eleanor->Url->special.\$Eleanor->Url->Construct(array(''module''=>''news''),false);', ''),
(4, 'english', 'Search', '', 'return\$Eleanor->Url->special.\$Eleanor->Url->Construct(array(''module''=>''search''),false);', ' rel="search"'),
(5, 'english', 'Sitemap', '', 'return\$Eleanor->Url->special.\$Eleanor->Url->Construct(array(''module''=>''sitemap''),false);', ''),
(6, 'english', 'Information', '', 'return\$Eleanor->Url->special.\$Eleanor->Url->Construct(array(''module''=>''pages''),false);', ''),
(7, 'english', 'Contacts', '', 'return\$Eleanor->Url->special.\$Eleanor->Url->Construct(array(''module''=>''contacts''),false);', ' rel="contact"'),
(8, 'english', 'Eleanor CMS', 'http://eleanor-cms.ru', '', ''),
(9, 'english', 'Official site Eleanor CMS', 'http://eleanor-cms.ru/eng/', '', ''),
(10, 'english', 'Supporting forum', 'http://eleanor-cms.ru/eng/forum/', '', ''),
(11, 'english', 'Eleanor Server', 'http://eleanor-cms.ru/eng/server/', '', '')
QUERY;
#[E] English
...
INSERT INTO `{$prefix}menu_l` (`id`, `language`, `title`, `url`, `eval_url`, `params`) VALUES
(1, 'ukrainian', 'Головна', '', 'return\$Eleanor->Url->special;', ''),
(2, 'ukrainian', 'Особистий кабінет', '', 'return\$Eleanor->Url->special.\$Eleanor->Url->Construct(array(''module''=>''аккаунт''),false);', ''),
(3, 'ukrainian', 'Новини', '', 'return\$Eleanor->Url->special.\$Eleanor->Url->Construct(array(''module''=>''новини''),false);', ''),
(4, 'ukrainian', 'Пошук', '', 'return\$Eleanor->Url->special.\$Eleanor->Url->Construct(array(''module''=>''пошук''),false);', ' rel="search"'),
(5, 'ukrainian', 'Мапа сайту', '', 'return\$Eleanor->Url->special.\$Eleanor->Url->Construct(array(''module''=>''мапа сайту''),false);', ''),
(6, 'ukrainian', 'Інформація', '', 'return\$Eleanor->Url->special.\$Eleanor->Url->Construct(array(''module''=>''сторінки''),false);', ''),
(7, 'ukrainian', 'Зворотній зв''язок', '', 'return\$Eleanor->Url->special.\$Eleanor->Url->Construct(array(''module''=>''зворотній зв\\\\''язок''),false);', ' rel="contact"'),
(8, 'ukrainian', 'Eleanor CMS', 'http://eleanor-cms.ru', '', ''),
(9, 'ukrainian', 'Офіційний сайт Eleanor CMS', 'http://eleanor-cms.ru/%D1%83%D0%BA%D1%80/', '', ''),
(10, 'ukrainian', 'Форум підтримки', 'http://eleanor-cms.ru/%D1%83%D0%BA%D1%80/%D1%84%D0%BE%D1%80%D1%83%D0%BC/', '', ''),
(11, 'ukrainian', 'Eleanor Server', 'http://eleanor-cms.ru/%D1%83%D0%BA%D1%80/%D1%81%D0%B5%D1%80%D0%B2%D0%B5%D1%80/', '', '')
QUERY;
#[E]Ukrainian
...
(2, ',1,', '{$ndate}' + INTERVAL 1 SECOND, NULL, 'Eleanor CMS', 0, 0, 1, 1, 0),
(3, ',1,', '{$ndate}', NULL, 'Eleanor CMS', 0, 0, 1, 1, 0)
QUERY;
