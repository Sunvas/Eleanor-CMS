...
(59, 'russian', 'E-mail отправителя', '', 'ss@ss.ru', 0, 'ss@ss.ru', '', ''),
(60, 'russian', 'Важность', '', '3', 0, '3', 'array(\r\n		''options''=>array(1=>''Высочайшая'',''Высокая'',''Обычная'',''Низкая'',''Низшая''),\r\n	)', ''),
...
(73, 'russian', 'Порядок сортировки комментариев', '', '1', 0, '1', 'array(\r\n		''options''=>array(1=>''Обратный'',''Прямой''),\r\n	)', ''),
...
(76, 'russian', 'Отображать комментарии для', '', 'a:6:{i:0;s:1:"4";i:1;s:1:"1";i:2;s:1:"3";i:3;s:1:"6";i:4;s:1:"5";i:5;s:1:"2";}', 1, 'a:6:{i:0;s:1:"4";i:1;s:1:"1";i:2;s:1:"3";i:3;s:1:"6";i:4;s:1:"5";i:5;s:1:"2";}', 'include Eleanor::$root.''addons/admin/options/groups.php'';', 'Права'),
(77, 'russian', 'Публикация комментариев доступна для', '', 'a:2:{i:0;s:1:"1";i:1;s:1:"2";}', 1, 'a:2:{i:0;s:1:"1";i:1;s:1:"2";}', 'include Eleanor::$root.''addons/admin/options/groups.php'';', ''),
...
(82, 'russian', 'Способ уменьшения изображения', '', 'small', 0, 'small', 'array(\r\n		''options''=>array(\r\n			''cut''=>''Обрезать'',\r\n			''small''=>''Уменьшить'',\r\n			''cutsmall''=>''Обрезать и уменьшить'',\r\n			''smallcut''=>''Уменьшить и обрезать'',\r\n		),\r\n	)', ''),
(83, 'russian', 'Создание превью начать с', '', 'b', 0, 'b', 'array(\r\n		''options''=>array(\r\n			''w''=>''Ширины'',\r\n			''h''=>''Высоты'',\r\n			''b''=>''Наибольшей стороны'',\r\n			''s''=>''Наименьшей стороны'',\r\n		),\r\n	)', ''),
...
(90, 'russian', 'Текст водяного знака', 'Этот текст будет наложен на изображение в качестве водяного знака, если изображение водяного знака недоступно.', '© Test', 0, '© Test', '', ''),
...
(94, 'russian', 'Секрет сайта', 'Случайная секретная строка при помощи которой будут подписываться данные для кросс-доменной коммутации.', '5066d63cee1c3', 0, '5066d63cee1c3', '', ''),
...
(98, 'russian', 'Страницы, выводимые на главной', 'Оставьте пустым для вывода содержания', '', 0, '', 'include Eleanor::$root.''modules/static/optionsg.php''', ''),
...
(59, 'ukrainian', 'E-mail відправника', 'С какого ящика будут приходить письма?', 'ss@ss.ru', 0, 'ss@ss.ru', '', ''),
(60, 'ukrainian', 'Важливість', '', '3', 0, '3', 'array(\r\n		''options''=>array(1=>''Найвища'',''Висока'',''Нормальна'',''Низька'',''Найнижча''),\r\n	)', ''),
...
(73, 'ukrainian', 'Порядок сортування коментарів', '', '1', 0, '1', 'array(\r\n		''options''=>array(1=>''Зворотний'',''Прямий''),\r\n	)', ''),
...
(76, 'ukrainian', 'Відображати коментарі для', '', 'a:6:{i:0;s:1:"4";i:1;s:1:"1";i:2;s:1:"3";i:3;s:1:"6";i:4;s:1:"5";i:5;s:1:"2";}', 1, 'a:6:{i:0;s:1:"4";i:1;s:1:"1";i:2;s:1:"3";i:3;s:1:"6";i:4;s:1:"5";i:5;s:1:"2";}', 'include Eleanor::$root.''addons/admin/options/groups.php'';', 'Права'),
(77, 'ukrainian', 'Публікація коментарів доступна для', '', 'a:2:{i:0;s:1:"1";i:1;s:1:"2";}', 1, 'a:2:{i:0;s:1:"1";i:1;s:1:"2";}', 'include Eleanor::$root.''addons/admin/options/groups.php'';', ''),
...
(82, 'ukrainian', 'Спосіб зменшення зображення', '', 'small', 0, 'small', 'array(\r\n		''options''=>array(\r\n			''cut''=>''Обрізати'',\r\n			''small''=>''Зменшити'',\r\n			''cutsmall''=>''Обрізати та зменшити'',\r\n			''smallcut''=>''Зменшити та обрізати'',\r\n		),\r\n	)', ''),
(83, 'ukrainian', 'Створення превью почати з', '', 'b', 0, 'b', 'array(\r\n		''options''=>array(\r\n			''w''=>''Ширини'',\r\n			''h''=>''Висоти'',\r\n			''b''=>''Найбільшої сторони'',\r\n			''s''=>''Найменшої сторони'',\r\n		),\r\n	)', ''),
...
(90, 'ukrainian', 'Текст водяного знака', 'Цей текст буде накладено на зображення в якості водяного знака, якщо зображення водяного знака недоступне.', '© Test', 0, '© Test', '', ''),
...
(94, 'ukrainian', 'Секрет сайту', 'Випадковий секретний рядок за допомогою якого будуть підписуватися дані для міждоменної комутації.', '5066d63cee1c3', 0, '5066d63cee1c3', '', ''),
...
(98, 'ukrainian', 'Сторінки, що виводиться на головній', 'Залиште пустим для виведення змісту', '', 0, '', 'include Eleanor::$root.''modules/static/optionsg.php''', ''),
...
(59, 'english', 'Sender e-mail', 'From what email letters will send?', 'ss@ss.ru', 0, 'ss@ss.ru', '', 'Общие настройки'),
(60, 'english', 'Importance', '', '3', 0, '3', 'array(\r\n		''options''=>array(1=>''Highest'',''High'',''Normal'',''Low'',''Lowest''),\r\n	);', ''),
...
(73, 'english', 'Order displaying comments', '', '1', 0, '1', 'array(\r\n		''options''=>array(1=>''Reverse'',''Direct''),\r\n	)', ''),
...
(76, 'english', 'Display comments for', '', 'a:6:{i:0;s:1:"4";i:1;s:1:"1";i:2;s:1:"3";i:3;s:1:"6";i:4;s:1:"5";i:5;s:1:"2";}', 1, 'a:6:{i:0;s:1:"4";i:1;s:1:"1";i:2;s:1:"3";i:3;s:1:"6";i:4;s:1:"5";i:5;s:1:"2";}', 'include Eleanor::$root.''addons/admin/options/groups.php'';', 'Rights'),
(77, 'english', 'Post comments available for', '', 'a:2:{i:0;s:1:"1";i:1;s:1:"2";}', 1, 'a:2:{i:0;s:1:"1";i:1;s:1:"2";}', 'include Eleanor::$root.''addons/admin/options/groups.php'';', ''),
...
(82, 'english', 'Method of reducing the image', '', 'small', 0, 'small', 'array(\r\n		''options''=>array(\r\n			''cut''=>''Crop'',\r\n			''small''=>''Reduce'',\r\n			''cutsmall''=>''Crop and reduce'',\r\n			''smallcut''=>''Reduce and crop'',\r\n		),\r\n	)', ''),
(83, 'english', 'Creating a thumb begin with', '', 'b', 0, 'b', 'array(\r\n		''options''=>array(\r\n			''w''=>''Width'',\r\n			''h''=>''Height'',\r\n			''b''=>''Biggest side'',\r\n			''s''=>''Smallest side'',\r\n		),\r\n	)', ''),
...
(90, 'english', 'Text watermark', 'This text will be superimposed on the image as a watermark, if the watermark image is not available.', '© Test', 0, '© Test', '', ''),
...
(94, 'english', 'Site secret', 'A random secret string with which to sign the data for cross-domain switching.', '5066d63cee1c3', 0, '5066d63cee1c3', '', ''),
...
(98, 'english', 'The pages displayed on the main', 'Leave empty to display contents', '', 0, '', 'include Eleanor::$root.''modules/static/optionsg.php''', ''),
