...
/*
	...
	@var tabindex для инпутов выбора автора. Всего шаблон выдает 2 инпута, tabindex-ы которых будут равны переднному параметру и переданному параметру + 1
*/
if(!defined('CMS'))die;
global$Eleanor;
...
return'<div class="author">'.Eleanor::Edit($an,$a,array('tabindex'=>$ti ? $ti : false)).Eleanor::Edit($aidn,$aid,array('title'=>'ID','style'=>'width: 25px','tabindex'=>$ti ? ++$ti : false))
