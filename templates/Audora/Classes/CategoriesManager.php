...
{	protected static function Menu($lang,$act='')
	{		$links=&$GLOBALS['Eleanor']->module['links_categories'];		$GLOBALS['Eleanor']->module['navigation']=array(
		...
		$subitems - массив подкатегорий для страниц из массива $items. Фомат: ID=>array(id=>array(), ...), где ID - идентификатор статической страницы, id - идентификатор категории. Ключи массива подкатегорий:
