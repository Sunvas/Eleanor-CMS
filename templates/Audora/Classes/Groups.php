	...
	*/
	protected static function Menu($act='')
	{		$lang=Eleanor::$Language['g'];
		...
		$items - массив групп пользователей. Формат: ID=>array(), ключи внутреннего массива (если какое-то значение равно null, значит свойство наследуется):
			...
			access_cp - флаг доступ в панель администратора
		...
		$subitems - массив подгрупп для групп из массива $items. Фомат: ID=>array(id=>array(), ...), где ID - идентификатор группы, id - идентификатор подгруппы. Ключи массива подгруппы:
