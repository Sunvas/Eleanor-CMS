...
/*
	...
	*Pseudonym
	...
	‘айл частоиспользуемых элементов шаблона
*/
class TplIndex
{	/*
		Ёлемент шаблона: листалка страниц

		$cnt - количество элементов
		$pp - количество элементов на страницу
		$page - номер текущей страницы, где мы сейчас находимс€
		$href - массив дл€ генератора ссылок Url, либо строка с участком {page} (этот участок может быть и в массиве)
		$ajax - название функции, куда будет передан запрос
		$hash - окончание ссылок дл€ страниц после знака #
