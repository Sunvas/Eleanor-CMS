...
{	protected static function Menu($act='')
	{		$lang=Eleanor::$Language['settings'];
		...
		$items - массив групп настроект. Формат: ID=>array(), ключи внутренних массивов:
			...
			_buttons - массив "кнопок" для группы, формат type=>link. Постоянные ключи:
				reset - ссылка на сброк настроек группы (значения их становятся значениями по умолчанию)
	...
	*/
	...
	/*
		...
		$controls - перечень контролов в соответствии с классом контролов. Если какой-то элемент массива не является массивом, значит это заголовок подгруппы контролов. Формат: name=>array(). Ключи внутреннего массива:
			...
			_aedit - ссылка на редктирование настройки или false
		...
		$errors - массив ошибок сохранения контролов. Если в массив существует ключ из массива контролов, ошибка долджна быть показана над контролом. Мультиязычная переменная.
