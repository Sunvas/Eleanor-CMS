...
$(function(){
	...
	/*
		...
		$values - массив значений полей
			Общие ключи:
			modules - ID-ы модулей, используемых в данном sitemap-е
		...
		$settings - массив настроек для модулей. Формат array(array(),array()...). Ключи внутренних массивов:
			...
			c - массив исходных конфигураций модуля, ключи
				...
				descr - (возможной ключ) описание настройки
			s - массив результирующего HTML для настроек, ключи сходы с ключами массива c выше.
