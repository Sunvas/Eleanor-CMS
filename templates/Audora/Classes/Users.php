...
$(function(){
	...
	*/
	...
	/*
		...
		$links - перечень необходимых ссылок, массив с ключами:
			sort_ip - ссылка на сортировку списка $items по ip (возрастанию/убыванию в зависимости от текущей сортировки)
			sort_enter - ссылка на сортировку списка $items дате входа (возрастанию/убыванию в зависимости от текущей сортировки)
			sort_location - ссылка на сортировку списка $items местоположению (возрастанию/убыванию в зависимости от текущей сортировки)
	*/
