...
/*
	...
	*Pseudonym
	...
	Шаблоны управления опросом. Фнутрь каждого метода подается ссылка на объект класса Voting_Manager, из которого необходимо брать контролы,
...
class TplVotingManager
{	/*
	...
	*/
	...
	/*
		...
		$variants - варианты ответов. Фомат: номер варианта=>вариант ответа
		$vn - префикс имен контролов вариантов ответа
		$answers - количество ответов каждого варианта. Фомат: номер варианта=>количество ответов. Может не отображаються, в случае, если это запрещено свойством $noans
