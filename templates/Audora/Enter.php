<?php
/*
	Ўаблон страницы входа в админку.
*/
if(!defined('CMS'))die;
...
echo 'Powered by '.ELEANOR_COPYRIGHT?>
		...
		<div class="msgbrowser">
			ƒл€ комфортного использовани€ нашей системы, рекомендуем ¬ам  воспользоватьс€ браузерами <a href="http://www.mozilla-europe.org/ru/firefox/" title="Mozilla Firefox">Mozilla Firefox</a> или <a href="http://ru.opera.com/" title="Opera">Opera</a>.
		</div>
	</div>
</body>
</html>