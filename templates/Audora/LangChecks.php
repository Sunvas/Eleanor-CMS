...
/*
	...
	@var флаг включенности галочки "Для всех языков"
	@var массив для определения включенности галочек для языков. По умолчанию язык считается включенным array('lang1'=>true,'lang2'=>false)
