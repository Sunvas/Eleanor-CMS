...
class TplComments
{	/*
		...
		$rights - массив прав пользоватя в комментарий, ключи:
			...
			status - раво менять статусы постов
		...
		$postquery - этот массив параметров должны быть переданы в $_POST запросе при ajax запросе
		...
		$statuses - массив количества комментариев каждого статуса. Ключи массива - числовое выражения статуса комментариев
	...
	*/	public static function ShowComments($rights,$pagpq,$postquery,$dataquery,$cnt,$pp,$page,$pages,$reverse,$statuses,$gname,$captcha,$links)
	...
	/*
		...
		$diff - массив разицы текущего времени и ранее опубликованного комментария, ключи:
			0 - годы
			1 - месяцы
			2 - дни
			3 - часы
	...
	*/
	...
	/*
		Элемент шаблона: текст комментария после его сохранения (после редактирования)
